...
# MENSAGEM_2-"MAIO"
mensagem = Label(window, text="AEE", font="calibri 16 bold")
mensagem.place(x=520,y=185)

# MENSAGEM_5Q1A-"1ª SEMANA"
mensagem = Label(window, text="1ª SEMANA", font="calibri 16 bold")
mensagem.place(x=5,y=120)

# MENSAGEM_5Q2B-"2ª SEMANA"
mensagem = Label(window, text="2ª SEMANA", font="calibri 16 bold")
mensagem.place(x=5,y=160)

# MENSAGEM_5Q1A-"1ª SEMANA"
mensagem = Label(window, text="3ª SEMANA", font="calibri 16 bold")
mensagem.place(x=5,y=200)

# MENSAGEM_5Q2B-"2ª SEMANA"
mensagem = Label(window, text="4ª SEMANA", font="calibri 16 bold")
mensagem.place(x=5,y=240)
...
ANO_5_8S1 = Button(window, text="5º ANO", command=aoClicar_ANO_5_8S1, bg='dim gray')
...
ANO_5_8S2 = Button(window, text="5º ANO", command=aoClicar_ANO_5_8S2, bg='dim gray')
...
ANO_5_8S3 = Button(window, text="5º ANO", command=aoClicar_ANO_5_8S3, bg='dim gray')
...
ANO_5_8S4 = Button(window, text="5º ANO", command=aoClicar_ANO_5_8S4, bg='dim gray')
ANO_5_8S4.place(x=444,y=245)
